//Program 9-19 from pages 539-540 of the textbook
//I have modified the program for it to not need C++11 so it will work on empress.csusm.edu
//No need to add the headers this time since we're just modifying an existing program that has its' own comment style, but do add your name and the date
//YOUR NAME:
//DATE:
